    ...
    <nav className="bg-[#0E1217] text-white flex items-center justify-between p-4 border-b border-gray-200 shadow-sm">
      ...
      <div className="flex-1 relative px-4 max-w-xl mx-auto">
        <img
          src={searchIcon}
          alt="Search"
          className="absolute left-6 top-1/2 transform -translate-y-1/2 h-4 w-4 opacity-60"
        />
        <Input
          value={search}
          onChange={(e) => setSearch(e.target.value)}
          placeholder="Search news..."
          className="w-full pl-10 pr-4 py-2 rounded-2xl bg-[#2D323D] text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-black"
        />
      </div>
